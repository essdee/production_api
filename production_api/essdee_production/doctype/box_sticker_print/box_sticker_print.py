...
class BoxStickerPrint(Document):
	...
	def apply_linked_lot_prices(self):
		# Manual Box Sticker Prints may intentionally use a different MRP. Only
		# stickers generated by a Work Order belong to the PPO-controlled flow.
		if self.against != "Work Order" or not self.against_id or not self.lot:
			return
