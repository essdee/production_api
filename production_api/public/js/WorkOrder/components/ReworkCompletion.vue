    ...
    <div ref="root" style="padding:20px;">
        <div style="display:flex;">
            ...
            <div style="padding-top:27px;">
                <button class="btn btn-primary" @click="get_rework_completion()">Show Report</button>
            </div>
        </div>
        <div>
...
function get_rework_completion(){
    if(!lot.get_value()){
    ...
    frappe.call({
        method: "production_api.production_api.doctype.grn_rework_item.grn_rework_item.get_rework_completion",
        args: {
            "lot": lot.get_value(),
