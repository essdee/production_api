<template>
    <div ref="root">
        ...
        <div class="row">
            ...
            <div v-if="selected_colour && status != 'Completed'" class="col-md-1 mt-4">
...
onMounted(() => {
    ...
    select_field.value = frappe.ui.form.make_control({
        ...
        df: {
            ...
            onchange: () => {
                frappe.call({
                    method: "production_api.essdee_production.doctype.time_and_action.time_and_action.get_time_and_action_details",
                    args: {
...
function make_complete(){
    frappe.call({
        method:"production_api.essdee_production.doctype.time_and_action.time_and_action.make_complete",
        args: {
