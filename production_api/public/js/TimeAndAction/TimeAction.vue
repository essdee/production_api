...
function update_work_station(){
    frappe.call({
        method:"production_api.essdee_production.doctype.work_station.work_station.get_work_stations",
        args : {
            "items": items.value,
        ...
        callback :async function(r){
            let d = new frappe.ui.Dialog({
                ...
                primary_action: () => {
                    ...
                    frappe.call({
                        method: "production_api.essdee_production.doctype.work_station.work_station.update_t_and_a_ws",
                        args : {
                            datas : updated_ws,
                        },
                        callback: function(){
